...
## 5. Design Log & Randări Mecanice

*(Proiectarea a ținut cont de constrângerile de spațiu, folosind capsule compacte BGA și QFN pentru a reduce footprint-ul plăcii, permițând integrarea ușoară într-o carcasă printată 3D).*
